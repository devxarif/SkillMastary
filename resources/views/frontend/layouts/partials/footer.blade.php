        ...
        <div class="footer-top">
            <div class="row">
                <div class="col-xl-4">
                    <div class="footer-textarea">
                        <div class="footer-logo">
                            <svg width="221" height="46" viewBox="0 0 221 46" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.4375 17.25L24 5.75L45.5625 17.25L24 28.75L2.4375 17.25Z"
                                    stroke="#FF6636" stroke-width="3.45" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M34.7812 43.125V23L24 17.25" stroke="#FF6636" stroke-width="3.45"
                                    ...
                                    <a href="#">
                                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="white" />
                                            <path d="M1.29297 5.98291H5.02497V18.0002H1.29297V5.98291Z"
                                                fill="white" />
                                            <path
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2.5 8H13.5" stroke="white" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9 3.5L13.5 8L9 12.5" stroke="white" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                </li>
                ...
                <div class="col-xl-2 col-lg-3  col-md-3">
                    <div class="footer-widget">
                        <div class="footer-menu-title dowmload-app">
                            <h4>Downlaod our app</h4>
                        </div>
                        <div class="app-btn-column">
                            <a class="app-btn" href="#">
                                <div class="app-btn-wrap">
                                    <div class="app-icon">
                                        <img src="{{ asset('frontend') }}/images/apple2.svg" alt="">
                                    </div>
                                    <div class="app-data">
                                        <p>Download now</p>
                                        <h5>App Store</h5>
