<div class="offcanves-menu">
    <div class="mobile-header">
        <div class="mobile-logo">
            <a href="index.html">
                <img src="{{ asset('frontend') }}/images/svg-icon/logo.svg" alt="brand-logo" />
            </a>
        </div>
        <span class="close">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6 6L18.7279 18.7279" stroke="#1D2026" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path d="M6.00006 19L18.728 6.27208" stroke="#1D2026" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round" />
            </svg>
        </span>
    </div>
    <div class="search-field-wrap mobile-search">
        <form action="#">
            <!-- Search Field  -->
                ...
                <a href="#">
                    <p>
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                            ...
                            <path d="M11.8125 3.9375L14.0625 6.1875" stroke="#8C94A3" stroke-width="1.125"
                            ...
                            <path
                                ...
                                stroke="#8C94A3" stroke-width="1.125" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        Edit Profile
                    </p>
                        ...
                        <a class="bell-icon" href="#">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#1D2026" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                        ...
                        <a href="#">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#1D2026" stroke="#1D2026" stroke-width="1.5" />
                                <path
    ...
    <div class="header-top">
        ...
        <div class="menu-bar">
            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 5.54468H21" stroke="#1D2026" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path d="M3 12.5447H21" stroke="#1D2026" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path d="M3 19.5447H21" stroke="#1D2026" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round" />
            </svg>
        </div>
    </div>
                ...
                <ul>
                    <li>
                        <a class="notification-icon" href="#">
                            ...
                            <div class="card card-activity notification-box">
