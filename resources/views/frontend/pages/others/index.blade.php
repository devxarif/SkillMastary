...
<div class="feature-course-section mt-2">
    <div class="container">
        <div class="feature-course-wrap">
                    ...
                    <div class="tw-flex tw-items-center tw-space-x-5">
                      <div class="tw-flex-shrink-0">
                        <div class="tw-relative">
                          <img class="tw-h-20 tw-w-20 tw-rounded-full" src="{{ $featuredInstructor?->user?->avatar_url }}" alt="">
                      ...
                      <div>
                        <h1 class="tw-text-2xl tw-font-bold tw-text-gray-900">
                            {{ $featuredInstructor?->user?->name }}
                        </h1>
                        <p class="tw-text-sm tw-font-medium tw-text-gray-500">
                            {{ __('Learning since') }} <time datetime="2020-08-25">{{ formatDate($featuredInstructor?->user?->created_at, 'M d, Y') }}</time></p>
                        <div class="tw-flex tw-justify-start profile-review mt-3">
                            <ul class="tw-flex tw-gap-3">
                              <li>
                                ...
                                <span>
                                    {{ $featuredInstructor?->avg_rating }}
                                </span>
                                ({{ $featuredInstructor?->total_reviews }} review)
                              </li>
                              <li>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span>
                                    {{ $featuredInstructor?->total_enrolled }}
                                </span>
                                {{ __('students') }}
                              </li>
                              <li>
                                ...
                                <span>{{ $featuredInstructor?->total_courses }}</span>
                                {{ __('courses') }}
                              </li>
                            </ul>
                          </div>
            ...
            <div class="footer-button text-center mt-3">
                <a class="button button--lg button-p-s button-i--r" href="http://127.0.0.1:8000/courses">
                    {{ __('View all featured courses') }}
                    <span>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.75 12H20.25" stroke="#FF6636" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                @foreach ($topInstructors as $instructor)
                    <div class="course-item-5">
                        <div class="course-item-5-card">
                            <a href="instructor-profile.html" class="course-item-5-card-img team-thumb">
                                <img src="{{ $instructor?->user?->avatar_url }}" alt="">
                            </a>
                            <div class="course-item-data">
                                <h5>{{ $instructor?->user?->name }}</h5>
                                <p>{{ $instructor?->user?->title }}</p>
                            </div>
                            <div class="course-item-5-card-footer">
                                ...
                                <p class="course-item-5-card-footer-student">
                                    {{ formatNumber($instructor?->total_enrolled) }} <span>{{ __('students') }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
