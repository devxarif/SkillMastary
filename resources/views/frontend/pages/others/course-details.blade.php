...
<div class="course-single-section section-padding" x-data="{tab: 'overview'}">
    <div class="container">
        <div class="row">
            <div class="col-xl-8">
                <div class="course-single-wrap">
                    ...
                    <div class="course-singe-main">
                        <div class="course-video-wrap" style="background-image: url({{ $course?->thumbnail_url }});">
                            <a class="popup-youtube" href="{{ $course?->video }}">
                    ...
                    <div class="student-profile-menu single-course">
                        <ul>
                            <li><a @click="tab = 'overview'" :class="tab == 'overview' ? 'active':''" href="javascript:void(0)">Overview</a></li>
                            <li><a @click="tab = 'curriculum'" :class="tab == 'curriculum' ? 'active':''" href="javascript:void(0)">Curriculum</a></li>
                            <li><a @click="tab = 'instructor'" :class="tab == 'instructor' ? 'active':''" href="javascript:void(0)">Instructor</a></li>
                            <li><a @click="tab = 'review'" :class="tab == 'review' ? 'active':''" href="javascript:void(0)">Review</a></li>
                        </ul>
                    </div>
                    <div x-show="tab == 'overview'" class="mt-5">
                        ...
                        <div class="course-learn-section">
                            ...
                            <div class="row">
                                @foreach ($course->courseLearnings as $course_learning)
                                    <div class="col-lg-6">
                                        <div class="checkbox-field tw-relative">
                    ...
                    <div x-show="tab == 'curriculum'" class="mt-5 course-curriculum-section">
                        <div class="course-single-title">
                            <h3>Curriculum</h3>
                    ...
                    <div x-show="tab == 'instructor'" class="mt-5 course-instructor-section">
                        <div class="course-single-title">
                    ...
                    <div x-show="tab == 'review'" class="mt-5 student-feedback-section">
                        ...
                        {{-- Reviews --}}
                        <livewire:frontend.course.course-details-review :course-id="$course->id"/>
                    </div>
                </div>
            </div>
            <div class="col-xl-4">
                <div class="course-right-sidebar">
                    ...
                    <div class="course-right-sidebar-row" x-data="{
                        ...
                        <div class="course-share-wrap">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" disabled class="form-control" x-model="copyText">
                                <button @click="copyToClipboard();" class="btn btn-outline-primary py-3 px-6 rounded-md" type="button" id="button-addon2">
                                    <span x-show="!copyNotification">Copy</span>
                                    <span x-show="copyNotification" style="display: none;">✓ Copied</span>
                                </button>
                            </div>
